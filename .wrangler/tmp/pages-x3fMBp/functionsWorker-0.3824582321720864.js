...
var LOCALE_PREFIX_REDIRECTS = /* @__PURE__ */ new Map([
  ["/", `/${DEFAULT_LOCALE}`],
...
__name(getLocalePrefixRedirect, "getLocalePrefixRedirect");
function redirectCareerApplyPath(url) {
  const match2 = url.pathname.match(
    /^((?:\/[a-z]{2})?\/career\/apply)\/(\d+)\/?$/
  );
  if (!match2) return null;
  const target = new URL(url);
  target.pathname = match2[1];
  target.searchParams.set("id", match2[2]);
  return target;
}
__name(redirectCareerApplyPath, "redirectCareerApplyPath");

// ../.wrangler/tmp/pages-x3fMBp/functionsRoutes-0.5162029427539138.mjs
var routes = [
  {
    routePath: "/",
    mountPath: "/",
...
// ../../../../../.nvm/versions/node/v25.5.0/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../.nvm/versions/node/v25.5.0/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;

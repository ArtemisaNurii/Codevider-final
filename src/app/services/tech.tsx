...
const technologies: TechnologyCategoryType[] = [
	...
	},
	{
		...
		items: [
			...
			{
				name: "Python",
				icon: <FaPython {...iconProps} className="text-blue-500" />,
			},
			{
				name: "Django",
	...
	},
	{
		...
		items: [
			...
			{
				name: "PostgreSQL",
				icon: <SiPostgresql {...iconProps} className="text-blue-600" />,
			},
			{
				name: "MySQL",
	...
	},
	{
		...
		items: [
			{
				name: "AWS",
				icon: <FaAws {...iconProps} className="text-orange-500" />,
			},
			{
				name: "Docker",
			...
			{
				name: "SiGooglecloud",
				icon: <SiGooglecloud {...iconProps} className="text-blue-500" />,
			},
			{
				name: "VscAzure",
				icon: <VscAzure {...iconProps} className="text-blue-500" />,
			},
			{
				name: "SiKubernetes",
	...
	},
	{
		...
		items: [
			...
			{
				name: "Figma",
				icon: <SiFigma {...iconProps} className="text-purple-500" />,
			},
			{
				name: "Anthropic",
				icon: <SiAnthropic {...iconProps} className="text-orange-600" />,
			},
			{
				name: "Mixtral",
				icon: <RiMixtralFill {...iconProps} className="text-orange-500" />,
			},
			{
				name: "Meta",
			...
			{
				name: "Huggingface",
				icon: <SiHuggingface {...iconProps} className="text-yellow-500" />,
			},
			{
				name: "Ollama",
			...
			{
				name: "Gemini",
				icon: <RiGeminiFill {...iconProps} className="text-blue-600" />,
			},
		],
	},
	{
		...
		items: [
			...
			{
				name: "PayPal",
				icon: <FaPaypal {...iconProps} className="text-blue-600" />,
			},
			{
				name: "Socket.IO",

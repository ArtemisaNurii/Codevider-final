			...
			{metrics.map((metric) => (
				...
				>
					<metric.icon
						...
						aria-hidden="true"
					/>
					<p className="mt-2 text-xl sm:text-2xl font-bold tracking-tight text-sky-800">
						{metric.value}
					</p>
...
const ContentSection = React.forwardRef<
	HTMLElement,
	{ section: CaseStudyContentSectionData; isLast?: boolean }
>(({ section, isLast = false }, ref) => (
	<section ref={ref} id={section.id} className="scroll-mt-24 content-section">
		<h2 className="font-serif text-2xl md:text-3xl font-bold text-gray-700">
			{section.title}
		</h2>
	...
	<div className="bg-white">
		<div className="mx-auto max-w-4xl py-12 px-6 text-center sm:py-16 lg:py-20">
			...
			<p className="mt-4 text-base sm:text-lg leading-7 text-gray-700 max-w-2xl mx-auto">
				Lets discuss how we can apply our expertise to elevate your project. We
				specialize in creating robust, scalable, and user-friendly digital
				solutions.
			</p>
			<div className="mt-8">
				<button
				...
				<div className="flex flex-col lg:flex-row lg:gap-12">
					...
					<aside className="w-full lg:w-1/4 lg:order-1">
						...
						<div className="hidden lg:block mt-8">
							<TableOfContents
								sections={caseStudyData.content}

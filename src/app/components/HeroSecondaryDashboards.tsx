...
import {
  BarChart2, TrendingUp, Users, Truck,
  Target, Zap, Clock, CheckCircle, RefreshCw, Eye, Globe, Package, MapPin,
} from 'lucide-react';

export type SecondaryViewId = 'analytics' | 'finance' | 'team' | 'operations';
...
type HeroSecondaryDashboardsProps = {
  view: SecondaryViewId;
};

export default function HeroSecondaryDashboards({ view }: HeroSecondaryDashboardsProps) {
  return (
    <>

			...
			<div className="flex flex-col gap-1 sm:gap-2">
				{navItems.map((item, index) => (
					<div
						key={index}
						title={item.tooltip}
						className={`relative w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-md lg:rounded-lg cursor-pointer transition-colors ${
							item.active
						...
						<div className="grid grid-cols-2 lg:grid-cols-4 gap-1.5 sm:gap-3 lg:gap-4">
							...
							>
								<div className="grid grid-cols-2 sm:grid-cols-3 gap-1 sm:gap-2 lg:gap-4 text-center mt-auto">
									<div>
										<p className="text-sm sm:text-lg lg:text-2xl font-bold text-sky-400">
											99.98%
										</p>
									...
									<div className="hidden sm:block">
										<p className="text-sm sm:text-lg lg:text-2xl font-bold text-yellow-400">
											3
										</p>
							...
							>
								<div className="flex items-start justify-start gap-2 sm:gap-3 h-full">
									<ShieldCheck
										size={18}
										className="text-sky-400 sm:w-6 sm:h-6"
									/>
							...
							<DashboardCard
								title="Transactions"
								icon={Clock}
								className="hidden sm:block col-span-2 lg:col-span-4"
							>

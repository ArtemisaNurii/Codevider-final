...
export default function NotFound() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-black to-slate-900 text-white font-sans">
      {/* Background Glow */}
      ...
      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center justify-center px-8 text-center md:flex-row md:justify-between md:text-left">
        ...
        <div className="max-w-md space-y-6">
          ...
          It seems like you&apos;re looking for a page that doesn&apos;t exist.
          </h1>
          <Link href="/">
            <button className="mt-4 flex flex-row gap-2 rounded-xl hover:gap-4 transition-all duration-300 ease-in-out border border-white/50 px-5 py-2 text-sm font-medium  hover:bg-white/10 hover:border-white">
        ...
        <div className="relative mt-16 flex flex-col items-center justify-center md:mt-0">
          {/* ... (rest of the 404 text styling) ... */}
           <span className="text-[10rem] font-black text-white/10 blur-sxs md:text-[18rem]">404</span>
          <span className="absolute text-[10rem] font-black text-white/20 blur-sm md:text-[18rem]">404</span>
          <span 
            className="absolute text-[10rem] font-black text-white md:text-[18rem]"
          ...
          >
            <span className="text-[10rem] font-black text-white blur-sm md:text-[18rem]">404</span>
          </div>
        </div>
      </div>

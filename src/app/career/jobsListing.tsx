...
export default function JobsListing({ page, limit }: JobsListingProps) {
        ...
        <>
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-start">
            ...
            <p className="text-lg text-start text-gray-600 mb-8 mx-auto">
              We may not have active openings right now, but we&apos;re always
              eager to connect with talented professionals.
  ...
  return (
    <>
      <header className="border-b text-white bg-gradient-to-br from-black via-slate-900 to-sky-800 border-slate-200">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24 md:mt-10 text-start">

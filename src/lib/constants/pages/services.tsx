		...
		},
		{
			...
			items: [
				...
				},
				{
					name: "Cohere",
					icon: returnImageComponent(
						"/images/stackIcons/ai/cohere.svg",
						"Cohere",
					),
				},
				{
					name: "Meta AI",
					icon: returnImageComponent(
						"/images/stackIcons/ai/metaAi.svg",
						"Meta AI",
					),
				},
				{
				...
				},
				{
					name: "DeepSeek",
					icon: returnImageComponent(
						"/images/stackIcons/ai/deepseek.svg",
						"DeepSeek",
					),
				},
				{
					name: "Moonshot",
					icon: returnImageComponent(
						"/images/stackIcons/ai/moonshot.png",
						"Moonshot",
					),
				},
				{
				...
				},
				{
					...
					name: "OpenRouter",
					icon: returnImageComponent(
						"/images/stackIcons/ai/openrouter.svg",
						"OpenRouter",
					),
				},

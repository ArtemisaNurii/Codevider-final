...
export const careerPage = {
	...
	processSteps: [
		{
			step: 1,
			icon: <FileText className="h-8 w-8 text-blue-900 stroke-1 md:stroke-2" />,
		...
		{
			step: 2,
			icon: <Users className="h-8 w-8 text-blue-900 stroke-1 md:stroke-2" />,
			title: "HR Interview",
			description:
		...
		{
			step: 4,
			icon: <Award className="h-8 w-8 text-blue-900 stroke-1 md:stroke-2" />,
			title: "The Offer",
			description:

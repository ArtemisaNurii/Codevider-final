...
export interface GradientBlindsProps {
	...
	mixBlendMode?: string;
	/** How the spotlight moves. "auto" drifts on its own; "mouse" follows the pointer. */
...
`;
		...
		let pointerTarget: Window | HTMLCanvasElement | null = null;
		if (spotlightMotion === "mouse") {
			pointerTarget = trackPointer === "section" ? window : canvas;

...
const statDescVariants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { type: 'spring' as const, duration: 0.4, bounce: 0, delay: 0.12 },
  },
}
...
export default function WhoWeAre() {
  ...
  return (
    ...
    >
      <div className="home-wrap grid w-full gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.85fr)] lg:gap-20 xl:gap-24">
        <motion.div
          initial={shouldReduceMotion ? false : 'hidden'}
          animate={inView ? 'visible' : 'hidden'}

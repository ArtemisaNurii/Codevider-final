  ...
  return (
    <div className="hero-dash-surface rounded-xl p-4 sm:p-5">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <Icon className="size-3.5 shrink-0 text-[var(--dash-brand)]" aria-hidden />
      </div>
      ...
      <div className="space-y-4 p-4 sm:space-y-5 sm:p-5">
        ...
        <div className="hero-dash-surface rounded-xl p-4 sm:p-5">
          <div className="mb-4 flex items-end justify-between gap-2">
            ...
            <span className="text-xs text-[var(--dash-warning)]">{t('revenue_period')}</span>
          </div>
        ...
        <div className="relative pb-2 sm:pb-3">
              ...
              {TRANSACTION_KEYS.map((key) => (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] text-[var(--dash-muted)]">{t(`${key}_meta`)}</p>
                  </div>
                  <span
                    className={`shrink-0 font-[family-name:var(--mono)] text-xs tabular-nums ${
                      key === 'tx_3' ? 'text-[var(--dash-warning)]' : 'text-[var(--dash-success)]'
                    }`}
                  >
                    {t(`${key}_amount`)}
                  </span>
          ...
          >
            <div className="flex items-start gap-2.5">
              ...
              <div className="min-w-0">
                <p className="text-xs font-medium text-[var(--dash-text)]">{t('toast_title')}</p>

						...
						<div className="grid grid-cols-3 gap-5 border-t border-[var(--border)] pt-10 sm:gap-10 sm:pt-12">
							{[
								...
								<div key={label} className="text-left">
									<p className="font-[family-name:var(--mono)] text-2xl font-medium tabular-nums tracking-tight text-[var(--text-h)] sm:text-3xl">
										{value}
									</p>
									<p className="mt-1 text-xs text-[var(--text)] sm:text-sm">
										{label}
									</p>
								</div>
							))}
